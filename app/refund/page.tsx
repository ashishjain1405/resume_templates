  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-16">
      ...
      <div className="text-gray-600 space-y-6 text-sm leading-relaxed">
        ...
        <h2 className="text-base font-semibold text-gray-900">Digital products</h2>
        <p>Because our templates are digital products that are available for immediate download after purchase, we generally do not offer refunds once the template has been downloaded.</p>
