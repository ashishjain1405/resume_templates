...
export const metadata: Metadata = {
  ...
  description: 'Browse all ATS-friendly resume templates — Classic, Modern, Multicolumn and more. One-time purchase, instant PDF download.',
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-12">
      <div className="text-center mb-10">
        ...
        <p className="text-gray-500 mb-4">Download once, keep forever. Available as instant PDF download.</p>
        <Link
