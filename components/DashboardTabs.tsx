            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="flex flex-col gap-3 p-6 bg-white border border-gray-200 rounded-2xl">
                ...
                <div className="min-w-0">
                  ...
                  <div className="text-sm font-bold text-gray-900 truncate">{latestResume.filename.replace(/\.pdf$/i, '').replace(/_/g, ' ')}</div>
          ...
          {latestResume && (
            <div className="bg-white border border-gray-200 rounded-2xl p-5 flex items-center justify-between gap-4">
              <div className="flex items-center gap-3 min-w-0">
                ...
                <div className="min-w-0">
                  <div className="text-sm font-medium text-gray-800 truncate">{latestResume.filename.replace(/\.pdf$/i, '').replace(/_/g, ' ')}</div>
